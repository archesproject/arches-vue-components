...
module.exports = {
  input: {
    path: "./arches_vue_components/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_vue_components/locale", // output path of all created files
