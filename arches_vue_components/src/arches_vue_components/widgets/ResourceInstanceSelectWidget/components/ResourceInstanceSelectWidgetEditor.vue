...
import { fetchRelatableResources } from "@/arches_vue_components/datatypes/resource-instance/api.ts";
...
} from "@/arches_vue_components/datatypes/resource-instance/types.ts";
